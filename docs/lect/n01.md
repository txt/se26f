...
<img width="1400" alt="split screen: Claude Code running tests in a worktree on the left; your editor on main, plus the diff-then-merge commands, on the right" src="../../etc/img/n01-agentpane.png" />
