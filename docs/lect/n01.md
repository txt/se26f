...
| Minutes | Segment |
|---|---|
| 10 | Where we are, 2026 |
| 30 | Git, three ways: shared drive, review-before-merge, agent herding |
| 25 | The LLM is a tool. Learn to hold it |
| 40 | Reading alien code |
| 25 | Exercise: what does "good" mean here? |
| 10 | Your two talks: the rules |
| 10 | ACM LaTeX quickstart |

---

## 0. Where we are, 2026 (10 min)
...
## 2. The LLM is a tool. Learn to hold it (25 min)
...
## 4. Exercise: what does "good" mean here? (25 min)
...
2. On screen: the poster folder, posters numbered 1...N.
...
7. Shared sheet (link posted in chat tonight): every group enters
   its constructs and scores.
...
## 5. Your two talks: the rules (10 min)
