...
| Minutes | Segment |
|---|---|
| 20 | Git: the six commands you need this week |
| 40 | The LLM is a tool. Learn to hold it |
| 60 | Reading alien code |
| 15 | Your two talks: the rules |
| 15 | ACM LaTeX in fifteen minutes |

---

## 1. Git: the six commands (20 min)
...
## 2. The LLM is a tool. Learn to hold it (40 min)
...
## 4. Your two talks: the rules (15 min)
