...
| Minutes | Segment |
|---|---|
| 90 | Eight patterns, with scars |
| 30 | Design essentials: coupling, cohesion, design-for-test |
| 30 | Project 1b clinic: live prompts + milestone realism |

---

## 0. Eight patterns, with scars (90 min)
...
moving parts, harder debugging. The names change; the bill does not.
...
agents wasting your review time. The old virtues got a new payday.
...
not ambition; it is a pre-written apology.
