...
<img alt="hierarchy of 35 student project clusters, from Innovation Leaders down to Standard Delivery" src="../../etc/img/project-clusters.png">
...
<img alt="ReqTrace and Clarity-AI, two innovation-leader student projects from 2025" src="../../etc/img/project-fig3.png">
